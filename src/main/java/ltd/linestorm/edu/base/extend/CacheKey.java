...
public class CacheKey {
	...
	/** 系统缓存 */
	public static final String CACHE_SYSETEM = "SystemCache";

	/** shiro 认证缓存 */
	public static final String CACHE_SHIRO_AUTHENTICATION = "shiro-authenticationCache";


	/** shiro 授权缓存 */
	public static final String CACHE_SHIRO_AUTHORIZATION = "shiro-authorizationCache";
	
	/** shiro session在线缓存 */
	public static final String CACHE_SHIRO_ACTIVESESSION = "shiro-activeSessionCache";
